...
internal class Day4KtTest {
    @Test
    internal fun `should count valid papers`() {
        val papers = """
    ...
    @Test
    internal fun `should count all valid papers with constraints`() {
        val papers = """
    ...
    @Test
    internal fun `should count all invalid papers with constraints`() {
        val papers = """
            eyr:1972 cid:100
